            ...
            <div class="sticky">
                <aside class="app-sidebar sidebar-scroll">
                    <div class="main-sidebar-header active">
                        <a class="desktop-logo logo-light active" href="{{url('/')}}"><img src="{{asset('assets/images/brand/logo.png')}}" class="main-logo" alt="logo"></a>
                        <a class="desktop-logo logo-dark active" href="{{url('/')}}"><img src="{{asset('assets/images/brand/logo1.png')}}" class="main-logo" alt="logo"></a>
                    ...
                    <div class="main-sidemenu">
                        <div class="app-sidebar__user">
                            <div class="dropdown user-pro-body text-center">
                                <div class="user-pic">
                            <img alt="user-img" class="avatar avatar-xl brround mb-1" src="{{asset('assets/images/users/16.jpg')}}">
                                </div>
                                <div class="user-info text-center">
                                    <h5 class=" mb-1 font-weight-bold">HAFIZUL ISLAM</h5>
                        ...
                        <ul class="side-menu">
                            ...
                            @include('layout.erp.menus.ads_menu')
                            @include('layout.erp.menus.adcampaign_menu')
                            @include('layout.erp.menus.post_menu')
                            @include('layout.erp.menus.adview_menu')
                            @include('layout.erp.menus.media_menu')
                            @include('layout.erp.menus.poll_menu')
                            @include('layout.erp.menus.poll_option_menu')
                            @include('layout.erp.menus.poll_vote_menu')
